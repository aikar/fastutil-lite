...
public interface Object2BooleanMap <K> extends Object2BooleanFunction <K>, Map<K,Boolean> {
	 ...
	 * @since 8.0.0
	 */
	default boolean replace(final K key, final boolean value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default boolean computeBooleanIfPresent(final K key, final java.util.function.BiFunction<? super K, ? super Boolean, ? extends Boolean> remappingFunction) {
	 ...
	 if (newValue == null) { removeBoolean(key); return drv; }
	 ...
	 * @since 8.0.0
	 */
	default boolean mergeBoolean(final K key, final boolean value, final java.util.function.BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final boolean oldValue = getBoolean(key), drv = defaultReturnValue();
	 final boolean newValue;
	 if (oldValue != drv || containsKey(key)) {
	  final Boolean mergedValue = remappingFunction.apply(Boolean.valueOf(oldValue), Boolean.valueOf(value));
	  if (mergedValue == null) { removeBoolean(key); return drv; }
