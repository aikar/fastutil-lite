...
public final class Object2BooleanFunctions {
	...
	public static class Singleton <K> extends AbstractObject2BooleanFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean getBoolean(final Object k) { return java.util.Objects.equals(key, k) ? value : defRetValue; }
	 @Override
	...
	public static class SynchronizedFunction <K> implements Object2BooleanFunction <K>, java.io.Serializable {
	 ...
	 @Override
	 public boolean test(K operand) { synchronized(sync) { return function.test(operand); } }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 public Boolean apply(final K key) { synchronized (sync) { return function.apply(key); } }
	 @Override
	 ...
	 */
	public static <K> Object2BooleanFunction <K> synchronize(final Object2BooleanFunction <K> f) { return new SynchronizedFunction <>(f); }
	 ...
	 * @see java.util.Collections#synchronizedMap(java.util.Map)
	 */
	public static <K> Object2BooleanFunction <K> synchronize(final Object2BooleanFunction <K> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }
	...
	public static class UnmodifiableFunction <K> extends AbstractObject2BooleanFunction <K> implements java.io.Serializable {
	 ...
	 @Deprecated
	 @Override
	 public Boolean get(final Object k) { return function.get(k); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <K> Object2BooleanFunction <K> unmodifiable(final Object2BooleanFunction <K> f) { return new UnmodifiableFunction <>(f); }
	...
	public static class PrimitiveFunction <K> implements Object2BooleanFunction <K> {
	 ...
	 @Deprecated
	 @Override
	 public Boolean put(final K key, final Boolean value) { throw new UnsupportedOperationException(); }
	}
