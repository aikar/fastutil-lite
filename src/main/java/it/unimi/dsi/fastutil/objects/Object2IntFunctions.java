...
public final class Object2IntFunctions {
	 ...
	 */
	public static class EmptyFunction <K> extends AbstractObject2IntFunction <K> implements java.io.Serializable, Cloneable {
	 private static final long serialVersionUID = -7046029254386353129L;
	 protected EmptyFunction() {}
	 @Override
	 public int getInt(final Object k) { return (0); }
	 @Override
	...
	public static class Singleton <K> extends AbstractObject2IntFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public int getInt(final Object k) { return java.util.Objects.equals(key, k) ? value : defRetValue; }
	 @Override
	...
	public static class SynchronizedFunction <K> implements Object2IntFunction <K>, java.io.Serializable {
	 ...
	 @Deprecated
	 @Override
	 public Integer apply(final K key) { synchronized (sync) { return function.apply(key); } }
	 @Override
	 ...
	 @Override
	 public int put(final K k, final int v) { synchronized(sync) { return function.put(k, v); } }
	 @Override
	 public int getInt(final Object k) { synchronized(sync) { return function.getInt(k); } }
	 @Override
	 public int removeInt(final Object k) { synchronized(sync) { return function.removeInt(k); } }
	 @Override
	 ...
	 @Deprecated
	 @Override
	 public Integer put(final K k, final Integer v) { synchronized(sync) { return function.put(k, v); } }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <K> Object2IntFunction <K> synchronize(final Object2IntFunction <K> f) { return new SynchronizedFunction <>(f); }
	 ...
	 * @see java.util.Collections#synchronizedMap(java.util.Map)
	 */
	public static <K> Object2IntFunction <K> synchronize(final Object2IntFunction <K> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }
	...
	public static class UnmodifiableFunction <K> extends AbstractObject2IntFunction <K> implements java.io.Serializable {
	 ...
	 @Override
	 public int getInt(final Object k) { return function.getInt(k); }
	 @Override
	 ...
	 @Deprecated
	 @Override
	 public Integer put(final K k, final Integer v) { throw new UnsupportedOperationException(); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 */
	public static <K> Object2IntFunction <K> unmodifiable(final Object2IntFunction <K> f) { return new UnmodifiableFunction <>(f); }
	...
	public static class PrimitiveFunction <K> implements Object2IntFunction <K> {
	 ...
	 @Deprecated
	 @Override
	 public Integer put(final K key, final Integer value) { throw new UnsupportedOperationException(); }
	}
	...
	public static <K> Object2IntFunction <K> primitive(final java.util.function.Function<? super K, ? extends Integer> f) {
	 ...
	 if (f instanceof Object2IntFunction) return (Object2IntFunction <K>) f;
