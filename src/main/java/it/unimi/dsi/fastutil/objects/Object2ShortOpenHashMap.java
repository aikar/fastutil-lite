...
/** A type-specific hash map with a fast, small-footprint implementation.
	...
	* @see HashCommon
	*/
public class Object2ShortOpenHashMap <K> extends AbstractObject2ShortMap <K> implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Object2ShortMap.Entry <K>, Map.Entry<K, Short> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return java.util.Objects.equals(key[index], (e.getKey())) && ( (value[index]) == ((e.getValue()).shortValue()) );
	 }
	 @Override
	 public int hashCode() {
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2ShortMap.Entry <K> > implements FastEntrySet <K> {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( (k) == null )) return Object2ShortOpenHashMap.this.containsNullKey && ( (value[n]) == (v) );
	  K curr;
	  final K[] key = Object2ShortOpenHashMap.this.key;
	  int pos;
	  // The starting point.
	...
	private final class KeySet extends AbstractObjectSet <K> {
	 ...
	 @Override
	 public void clear() { Object2ShortOpenHashMap.this.clear();}
	}
	@Override
