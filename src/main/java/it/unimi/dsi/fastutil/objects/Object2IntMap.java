...
public interface Object2IntMap <K> extends Object2IntFunction <K>, Map<K,Integer> {
	 ...
	 * @since 8.0.0
	 */
	default int replace(final K key, final int value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	default int computeIntIfPresent(final K key, final java.util.function.BiFunction<? super K, ? super Integer, ? extends Integer> remappingFunction) {
	 ...
	 if (newValue == null) { removeInt(key); return drv; }
	 ...
	 * @since 8.0.0
	 */
	default int mergeInt(final K key, final int value, final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int oldValue = getInt(key), drv = defaultReturnValue();
	 final int newValue;
	 if (oldValue != drv || containsKey(key)) {
	  final Integer mergedValue = remappingFunction.apply(Integer.valueOf(oldValue), Integer.valueOf(value));
	  if (mergedValue == null) { removeInt(key); return drv; }
