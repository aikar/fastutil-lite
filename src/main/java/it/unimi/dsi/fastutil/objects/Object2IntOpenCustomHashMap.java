...
/** A type-specific hash map with a fast, small-footprint implementation whose {@linkplain it.unimi.dsi.fastutil.Hash.Strategy hashing strategy}
	...
	*/
public class Object2IntOpenCustomHashMap <K> extends AbstractObject2IntMap <K> implements java.io.Serializable, Cloneable, Hash {
	 ...
	 */
	public Object2IntOpenCustomHashMap(final Map<? extends K, ? extends Integer> m, final float f, final Strategy <? super K> strategy) {
	 ...
	 */
	public Object2IntOpenCustomHashMap(final Map<? extends K, ? extends Integer> m, final Strategy <? super K> strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public int mergeInt(final K k, final int v, final java.util.function.BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	 if (pos < 0) {
	  insert(-pos - 1, k, v);
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2IntMap.Entry <K> > implements FastEntrySet <K> {
	 @Override
	 public ObjectIterator<Object2IntMap.Entry <K> > iterator() { return new EntryIterator(); }
	 @Override
	 public ObjectIterator<Object2IntMap.Entry <K> > fastIterator() { return new FastEntryIterator(); }
	 @Override
	 @SuppressWarnings("unchecked")
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (null) ) )) return Object2IntOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	  K curr;
	  final K[] key = Object2IntOpenCustomHashMap.this.key;
	  int pos;
	  // The starting point.
	 ...
	 public void forEach(final Consumer<? super Object2IntMap.Entry <K> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractObject2IntMap.BasicEntry <K>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == null )) consumer.accept(new AbstractObject2IntMap.BasicEntry <K>(key[pos], value[pos]));
	 }
	 /** {@inheritDoc} */
	 @Override
	...
	private final class KeySet extends AbstractObjectSet <K> {
	 ...
	 @Override
	 public void clear() { Object2IntOpenCustomHashMap.this.clear();}
	}
	@Override
	...
	public IntCollection values() {
	 if (values == null) values = new AbstractIntCollection () {
	   @Override
	   public IntIterator iterator() { return new ValueIterator(); }
	   @Override
	   public int size() { return size; }
	   @Override
	   public boolean contains(int v) { return containsValue(v); }
	   @Override
	   public void clear() { Object2IntOpenCustomHashMap.this.clear(); }
	   /** {@inheritDoc} */
	   @Override
