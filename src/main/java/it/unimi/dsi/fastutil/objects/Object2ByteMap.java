...
public interface Object2ByteMap <K> extends Object2ByteFunction <K>, Map<K,Byte> {
	 ...
	 * @since 8.0.0
	 */
	default byte replace(final K key, final byte value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	 ...
	 * @since 8.0.0
	 */
	default byte computeByteIfPresent(final K key, final java.util.function.BiFunction<? super K, ? super Byte, ? extends Byte> remappingFunction) {
	 ...
	 if (newValue == null) { removeByte(key); return drv; }
	 ...
	 * @since 8.0.0
	 */
	default byte computeByte(final K key, final java.util.function.BiFunction<? super K, ? super Byte, ? extends Byte> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final byte oldValue = getByte(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default byte mergeByte(final K key, final byte value, final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final byte oldValue = getByte(key), drv = defaultReturnValue();
	 final byte newValue;
	 if (oldValue != drv || containsKey(key)) {
	  final Byte mergedValue = remappingFunction.apply(Byte.valueOf(oldValue), Byte.valueOf(value));
	  if (mergedValue == null) { removeByte(key); return drv; }
	...
	@Deprecated
	@Override
	default Byte merge(final K key, final Byte value, final java.util.function.BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
