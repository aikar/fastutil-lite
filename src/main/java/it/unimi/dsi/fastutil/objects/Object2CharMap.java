...
public interface Object2CharMap <K> extends Object2CharFunction <K>, Map<K,Character> {
	 ...
	 * @since 8.0.0
	 */
	default char replace(final K key, final char value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	 ...
	 * @since 8.0.0
	 */
	default char computeCharIfPresent(final K key, final java.util.function.BiFunction<? super K, ? super Character, ? extends Character> remappingFunction) {
	 ...
	 if (newValue == null) { removeChar(key); return drv; }
	 ...
	 * @since 8.0.0
	 */
	default char computeChar(final K key, final java.util.function.BiFunction<? super K, ? super Character, ? extends Character> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final char oldValue = getChar(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default char mergeChar(final K key, final char value, final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final char oldValue = getChar(key), drv = defaultReturnValue();
	 final char newValue;
	 if (oldValue != drv || containsKey(key)) {
	  final Character mergedValue = remappingFunction.apply(Character.valueOf(oldValue), Character.valueOf(value));
	  if (mergedValue == null) { removeChar(key); return drv; }
	...
	@Deprecated
	@Override
	default Character merge(final K key, final Character value, final java.util.function.BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
