...
public final class Object2CharFunctions {
	...
	public static class Singleton <K> extends AbstractObject2CharFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public char getChar(final Object k) { return java.util.Objects.equals(key, k) ? value : defRetValue; }
	 @Override
	...
	public static class SynchronizedFunction <K> implements Object2CharFunction <K>, java.io.Serializable {
	 ...
	 @Deprecated
	 @Override
	 public Character apply(final K key) { synchronized (sync) { return function.apply(key); } }
	 @Override
	 ...
	 */
	public static <K> Object2CharFunction <K> synchronize(final Object2CharFunction <K> f) { return new SynchronizedFunction <>(f); }
	 ...
	 * @see java.util.Collections#synchronizedMap(java.util.Map)
	 */
	public static <K> Object2CharFunction <K> synchronize(final Object2CharFunction <K> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }
	...
	public static class UnmodifiableFunction <K> extends AbstractObject2CharFunction <K> implements java.io.Serializable {
	 ...
	 @Deprecated
	 @Override
	 public Character put(final K k, final Character v) { throw new UnsupportedOperationException(); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 public Character get(final Object k) { return function.get(k); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 public Character remove(final Object k) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 */
	public static <K> Object2CharFunction <K> unmodifiable(final Object2CharFunction <K> f) { return new UnmodifiableFunction <>(f); }
	...
	public static class PrimitiveFunction <K> implements Object2CharFunction <K> {
	 ...
	 @Deprecated
	 @Override
	 public Character put(final K key, final Character value) { throw new UnsupportedOperationException(); }
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Object2CharFunction <K> primitive(final java.util.function.Function<? super K, ? extends Character> f) {
	 java.util.Objects.requireNonNull(f);
	 if (f instanceof Object2CharFunction) return (Object2CharFunction <K>) f;
	 if (f instanceof java.util.function.ToIntFunction)
	  return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToChar(((java.util.function.ToIntFunction <K>) f).applyAsInt((K)(key)));
