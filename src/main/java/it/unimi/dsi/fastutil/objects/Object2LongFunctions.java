...
public final class Object2LongFunctions {
	...
	public static class Singleton <K> extends AbstractObject2LongFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public long getLong(final Object k) { return java.util.Objects.equals(key, k) ? value : defRetValue; }
	 @Override
	...
	public static class SynchronizedFunction <K> implements Object2LongFunction <K>, java.io.Serializable {
	 ...
	 @Override
	 public long applyAsLong(K operand) { synchronized(sync) { return function.applyAsLong(operand); } }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 public Long apply(final K key) { synchronized (sync) { return function.apply(key); } }
	 @Override
	 ...
	 */
	public static <K> Object2LongFunction <K> synchronize(final Object2LongFunction <K> f) { return new SynchronizedFunction <>(f); }
	 ...
	 * @see java.util.Collections#synchronizedMap(java.util.Map)
	 */
	public static <K> Object2LongFunction <K> synchronize(final Object2LongFunction <K> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }
	 ...
	 */
	public static <K> Object2LongFunction <K> unmodifiable(final Object2LongFunction <K> f) { return new UnmodifiableFunction <>(f); }
	...
	public static class PrimitiveFunction <K> implements Object2LongFunction <K> {
	 ...
	 @Deprecated
	 @Override
	 public Long put(final K key, final Long value) { throw new UnsupportedOperationException(); }
	}
	...
	public static <K> Object2LongFunction <K> primitive(final java.util.function.Function<? super K, ? extends Long> f) {
	 ...
	 if (f instanceof Object2LongFunction) return (Object2LongFunction <K>) f;
