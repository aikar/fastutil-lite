...
/** A type-specific hash map with a fast, small-footprint implementation.
	...
	* @see HashCommon
	*/
public class Object2BooleanOpenHashMap <K> extends AbstractObject2BooleanMap <K> implements java.io.Serializable, Cloneable, Hash {
	...
	/** {@inheritDoc} */
	@Override
	public boolean mergeBoolean(final K k, final boolean v, final java.util.function.BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	 if (pos < 0) {
	  insert(-pos - 1, k, v);
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2BooleanMap.Entry <K> > implements FastEntrySet <K> {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( (k) == null )) return Object2BooleanOpenHashMap.this.containsNullKey && ( (value[n]) == (v) );
	  K curr;
	  final K[] key = Object2BooleanOpenHashMap.this.key;
	  int pos;
	  // The starting point.
	...
	private final class KeySet extends AbstractObjectSet <K> {
	 ...
	 @Override
	 public void clear() { Object2BooleanOpenHashMap.this.clear();}
	}
	@Override
