...
/** An abstract class providing basic methods for maps implementing a type-specific interface.
	...
	*/
public abstract class AbstractObject2BooleanMap <K> extends AbstractObject2BooleanFunction <K> implements Object2BooleanMap <K>, java.io.Serializable {
	...
	public ObjectSet <K> keySet() {
	 return new AbstractObjectSet <K>() {
	   ...
	   @Override
	   public int size() { return AbstractObject2BooleanMap.this.size(); }
	   @Override
	   public void clear() { AbstractObject2BooleanMap.this.clear(); }
	   @Override
