...
/** A type-specific hash map with a fast, small-footprint implementation.
	...
	* @see HashCommon
	*/
public class Object2ByteOpenHashMap <K> extends AbstractObject2ByteMap <K> implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Object2ByteMap.Entry <K>, Map.Entry<K, Byte> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return java.util.Objects.equals(key[index], (e.getKey())) && ( (value[index]) == ((e.getValue()).byteValue()) );
	 }
	 @Override
	 public int hashCode() {
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2ByteMap.Entry <K> > implements FastEntrySet <K> {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( (k) == null )) return Object2ByteOpenHashMap.this.containsNullKey && ( (value[n]) == (v) );
	  K curr;
	  final K[] key = Object2ByteOpenHashMap.this.key;
	  int pos;
	  // The starting point.
	...
	private final class KeySet extends AbstractObjectSet <K> {
	 ...
	 @Override
	 public void clear() { Object2ByteOpenHashMap.this.clear();}
	}
	@Override
