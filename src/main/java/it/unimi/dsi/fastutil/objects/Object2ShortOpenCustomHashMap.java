...
/** A type-specific hash map with a fast, small-footprint implementation whose {@linkplain it.unimi.dsi.fastutil.Hash.Strategy hashing strategy}
	...
	*/
public class Object2ShortOpenCustomHashMap <K> extends AbstractObject2ShortMap <K> implements java.io.Serializable, Cloneable, Hash {
	 ...
	 */
	public Object2ShortOpenCustomHashMap(final Map<? extends K, ? extends Short> m, final float f, final Strategy <? super K> strategy) {
	 ...
	 */
	public Object2ShortOpenCustomHashMap(final Map<? extends K, ? extends Short> m, final Strategy <? super K> strategy) {
	 ...
	 */
	public Object2ShortOpenCustomHashMap(final Object2ShortMap <K> m, final float f, final Strategy <? super K> strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	 ...
	 */
	public Object2ShortOpenCustomHashMap(final K[] k, final short[] v, final float f, final Strategy <? super K> strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public short computeShortIfPresent(final K k, final java.util.function.BiFunction<? super K, ? super Short, ? extends Short> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public short computeShort(final K k, final java.util.function.BiFunction<? super K, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public short mergeShort(final K k, final short v, final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	 if (pos < 0) {
	  insert(-pos - 1, k, v);
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2ShortMap.Entry <K> > implements FastEntrySet <K> {
	 @Override
	 public ObjectIterator<Object2ShortMap.Entry <K> > iterator() { return new EntryIterator(); }
	 @Override
	 public ObjectIterator<Object2ShortMap.Entry <K> > fastIterator() { return new FastEntryIterator(); }
	 @Override
	 @SuppressWarnings("unchecked")
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (null) ) )) return Object2ShortOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	  K curr;
	  final K[] key = Object2ShortOpenCustomHashMap.this.key;
	  int pos;
	  // The starting point.
	 ...
	 public void forEach(final Consumer<? super Object2ShortMap.Entry <K> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractObject2ShortMap.BasicEntry <K>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == null )) consumer.accept(new AbstractObject2ShortMap.BasicEntry <K>(key[pos], value[pos]));
	 }
	 /** {@inheritDoc} */
	 @Override
	...
	private final class KeySet extends AbstractObjectSet <K> {
	 ...
	 @Override
	 public void clear() { Object2ShortOpenCustomHashMap.this.clear();}
	}
	@Override
	...
	public ShortCollection values() {
	 if (values == null) values = new AbstractShortCollection () {
	   @Override
	   public ShortIterator iterator() { return new ValueIterator(); }
	   @Override
	   public int size() { return size; }
	   @Override
	   public boolean contains(short v) { return containsValue(v); }
	   @Override
	   public void clear() { Object2ShortOpenCustomHashMap.this.clear(); }
	   /** {@inheritDoc} */
	   @Override
