...
public final class Object2ShortFunctions {
	 ...
	 */
	public static class EmptyFunction <K> extends AbstractObject2ShortFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 * a type-specific function.
	 */
	public static class Singleton <K> extends AbstractObject2ShortFunction <K> implements java.io.Serializable, Cloneable {
	 private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 @Override
	 public short getShort(final Object k) { return java.util.Objects.equals(key, k) ? value : defRetValue; }
	 @Override
	...
	public static class SynchronizedFunction <K> implements Object2ShortFunction <K>, java.io.Serializable {
	 ...
	 @Deprecated
	 @Override
	 public Short apply(final K key) { synchronized (sync) { return function.apply(key); } }
	 @Override
	 ...
	 */
	public static <K> Object2ShortFunction <K> synchronize(final Object2ShortFunction <K> f) { return new SynchronizedFunction <>(f); }
	 ...
	 * @see java.util.Collections#synchronizedMap(java.util.Map)
	 */
	public static <K> Object2ShortFunction <K> synchronize(final Object2ShortFunction <K> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }
	/** An unmodifiable wrapper class for functions. */
	public static class UnmodifiableFunction <K> extends AbstractObject2ShortFunction <K> implements java.io.Serializable {
	 private static final long serialVersionUID = -7046029254386353129L;
	 protected final Object2ShortFunction <K> function;
	 ...
	 @Deprecated
	 @Override
	 public Short get(final Object k) { return function.get(k); }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 public Short remove(final Object k) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 */
	public static <K> Object2ShortFunction <K> unmodifiable(final Object2ShortFunction <K> f) { return new UnmodifiableFunction <>(f); }
	...
	public static class PrimitiveFunction <K> implements Object2ShortFunction <K> {
	 ...
	 @Deprecated
	 @Override
	 public Short put(final K key, final Short value) { throw new UnsupportedOperationException(); }
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Object2ShortFunction <K> primitive(final java.util.function.Function<? super K, ? extends Short> f) {
	 java.util.Objects.requireNonNull(f);
	 if (f instanceof Object2ShortFunction) return (Object2ShortFunction <K>) f;
	 if (f instanceof java.util.function.ToIntFunction)
	  return key -> it.unimi.dsi.fastutil.SafeMath.safeIntToShort(((java.util.function.ToIntFunction <K>) f).applyAsInt((K)(key)));
