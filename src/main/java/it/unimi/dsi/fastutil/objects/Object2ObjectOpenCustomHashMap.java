...
/** A type-specific hash map with a fast, small-footprint implementation whose {@linkplain it.unimi.dsi.fastutil.Hash.Strategy hashing strategy}
	...
	*/
public class Object2ObjectOpenCustomHashMap <K,V> extends AbstractObject2ObjectMap <K,V> implements java.io.Serializable, Cloneable, Hash {
	 ...
	 */
	public Object2ObjectOpenCustomHashMap(final Map<? extends K, ? extends V> m, final float f, final Strategy <? super K> strategy) {
	 ...
	 */
	public Object2ObjectOpenCustomHashMap(final Object2ObjectMap <K,V> m, final float f, final Strategy <? super K> strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2ObjectMap.Entry <K,V> > implements FastEntrySet <K,V> {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (null) ) )) return Object2ObjectOpenCustomHashMap.this.containsNullKey && java.util.Objects.equals(value[n], v);
	  K curr;
	  final K[] key = Object2ObjectOpenCustomHashMap.this.key;
	  int pos;
	  // The starting point.
	...
	private final class KeySet extends AbstractObjectSet <K> {
	 ...
	 @Override
	 public void clear() { Object2ObjectOpenCustomHashMap.this.clear();}
	}
	@Override
