...
public interface Object2ShortMap <K> extends Object2ShortFunction <K>, Map<K,Short> {
	 ...
	 * @since 8.0.0
	 */
	default short replace(final K key, final short value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	 ...
	 * @since 8.0.0
	 */
	default short computeShortIfPresent(final K key, final java.util.function.BiFunction<? super K, ? super Short, ? extends Short> remappingFunction) {
	 ...
	 if (newValue == null) { removeShort(key); return drv; }
	 ...
	 * @since 8.0.0
	 */
	default short computeShort(final K key, final java.util.function.BiFunction<? super K, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final short oldValue = getShort(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default short mergeShort(final K key, final short value, final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final short oldValue = getShort(key), drv = defaultReturnValue();
	 final short newValue;
	 if (oldValue != drv || containsKey(key)) {
	  final Short mergedValue = remappingFunction.apply(Short.valueOf(oldValue), Short.valueOf(value));
	  if (mergedValue == null) { removeShort(key); return drv; }
	...
	@Deprecated
	@Override
	default Short merge(final K key, final Short value, final java.util.function.BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
