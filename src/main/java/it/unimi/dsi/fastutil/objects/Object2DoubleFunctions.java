...
public final class Object2DoubleFunctions {
	...
	public static class Singleton <K> extends AbstractObject2DoubleFunction <K> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public double getDouble(final Object k) { return java.util.Objects.equals(key, k) ? value : defRetValue; }
	 @Override
	...
	public static class SynchronizedFunction <K> implements Object2DoubleFunction <K>, java.io.Serializable {
	 ...
	 @Deprecated
	 @Override
	 public Double apply(final K key) { synchronized (sync) { return function.apply(key); } }
	 @Override
	 ...
	 */
	public static <K> Object2DoubleFunction <K> synchronize(final Object2DoubleFunction <K> f) { return new SynchronizedFunction <>(f); }
	 ...
	 * @see java.util.Collections#synchronizedMap(java.util.Map)
	 */
	public static <K> Object2DoubleFunction <K> synchronize(final Object2DoubleFunction <K> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }
	 ...
	 */
	public static <K> Object2DoubleFunction <K> unmodifiable(final Object2DoubleFunction <K> f) { return new UnmodifiableFunction <>(f); }
	...
	public static class PrimitiveFunction <K> implements Object2DoubleFunction <K> {
	 ...
	 @Deprecated
	 @Override
	 public Double put(final K key, final Double value) { throw new UnsupportedOperationException(); }
	}
