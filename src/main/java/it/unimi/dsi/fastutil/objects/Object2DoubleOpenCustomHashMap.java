...
/** A type-specific hash map with a fast, small-footprint implementation whose {@linkplain it.unimi.dsi.fastutil.Hash.Strategy hashing strategy}
	...
	*/
public class Object2DoubleOpenCustomHashMap <K> extends AbstractObject2DoubleMap <K> implements java.io.Serializable, Cloneable, Hash {
	 ...
	 */
	public Object2DoubleOpenCustomHashMap(final Map<? extends K, ? extends Double> m, final float f, final Strategy <? super K> strategy) {
	 ...
	 */
	public Object2DoubleOpenCustomHashMap(final Map<? extends K, ? extends Double> m, final Strategy <? super K> strategy) {
	 ...
	 */
	public Object2DoubleOpenCustomHashMap(final Object2DoubleMap <K> m, final float f, final Strategy <? super K> strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	 ...
	 */
	public Object2DoubleOpenCustomHashMap(final K[] k, final double[] v, final float f, final Strategy <? super K> strategy) {
	...
	/** {@inheritDoc} */
	@Override
	public double computeDoubleIfAbsent(final K k, final java.util.function.ToDoubleFunction <? super K> mappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public double mergeDouble(final K k, final double v, final java.util.function.BiFunction<? super Double, ? super Double, ? extends Double> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	 if (pos < 0) {
	  insert(-pos - 1, k, v);
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2DoubleMap.Entry <K> > implements FastEntrySet <K> {
	 @Override
	 public ObjectIterator<Object2DoubleMap.Entry <K> > iterator() { return new EntryIterator(); }
	 @Override
	 public ObjectIterator<Object2DoubleMap.Entry <K> > fastIterator() { return new FastEntryIterator(); }
	 @Override
	 @SuppressWarnings("unchecked")
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (null) ) )) return Object2DoubleOpenCustomHashMap.this.containsNullKey && ( Double.doubleToLongBits(value[n]) == Double.doubleToLongBits(v) );
	  K curr;
	  final K[] key = Object2DoubleOpenCustomHashMap.this.key;
	  int pos;
	  // The starting point.
	 ...
	 public void forEach(final Consumer<? super Object2DoubleMap.Entry <K> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractObject2DoubleMap.BasicEntry <K>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == null )) consumer.accept(new AbstractObject2DoubleMap.BasicEntry <K>(key[pos], value[pos]));
	 }
	 /** {@inheritDoc} */
	 @Override
	...
	private final class KeySet extends AbstractObjectSet <K> {
	 ...
	 @Override
	 public void clear() { Object2DoubleOpenCustomHashMap.this.clear();}
	}
	@Override
