...
/** A type-specific hash map with a fast, small-footprint implementation whose {@linkplain it.unimi.dsi.fastutil.Hash.Strategy hashing strategy}
	...
	*/
public class Object2LongOpenCustomHashMap <K> extends AbstractObject2LongMap <K> implements java.io.Serializable, Cloneable, Hash {
	 ...
	 */
	public Object2LongOpenCustomHashMap(final Map<? extends K, ? extends Long> m, final float f, final Strategy <? super K> strategy) {
	 ...
	 */
	public Object2LongOpenCustomHashMap(final K[] k, final long[] v, final float f, final Strategy <? super K> strategy) {
	...
	private final class MapEntrySet extends AbstractObjectSet<Object2LongMap.Entry <K> > implements FastEntrySet <K> {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (null) ) )) return Object2LongOpenCustomHashMap.this.containsNullKey && ( (value[n]) == (v) );
	  K curr;
	  final K[] key = Object2LongOpenCustomHashMap.this.key;
	  int pos;
	  // The starting point.
	...
	private final class KeySet extends AbstractObjectSet <K> {
	 ...
	 @Override
	 public void clear() { Object2LongOpenCustomHashMap.this.clear();}
	}
	@Override
