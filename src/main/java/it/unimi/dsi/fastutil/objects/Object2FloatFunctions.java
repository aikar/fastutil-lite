...
public final class Object2FloatFunctions {
	 ...
	 */
	public static class EmptyFunction <K> extends AbstractObject2FloatFunction <K> implements java.io.Serializable, Cloneable {
	 private static final long serialVersionUID = -7046029254386353129L;
	 protected EmptyFunction() {}
	 @Override
	 public float getFloat(final Object k) { return (0); }
	 @Override
	 ...
	 * a type-specific function.
	 */
	public static class Singleton <K> extends AbstractObject2FloatFunction <K> implements java.io.Serializable, Cloneable {
	 private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 @Override
	 public float getFloat(final Object k) { return java.util.Objects.equals(key, k) ? value : defRetValue; }
	 @Override
	...
	public static class SynchronizedFunction <K> implements Object2FloatFunction <K>, java.io.Serializable {
	 ...
	 @Override
	 public double applyAsDouble(K operand) { synchronized(sync) { return function.applyAsDouble(operand); } }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 public Float apply(final K key) { synchronized (sync) { return function.apply(key); } }
	 @Override
	 ...
	 @Override
	 public float put(final K k, final float v) { synchronized(sync) { return function.put(k, v); } }
	 @Override
	 public float getFloat(final Object k) { synchronized(sync) { return function.getFloat(k); } }
	 @Override
	 public float removeFloat(final Object k) { synchronized(sync) { return function.removeFloat(k); } }
	 @Override
	 ...
	 */
	public static <K> Object2FloatFunction <K> synchronize(final Object2FloatFunction <K> f) { return new SynchronizedFunction <>(f); }
	 ...
	 * @see java.util.Collections#synchronizedMap(java.util.Map)
	 */
	public static <K> Object2FloatFunction <K> synchronize(final Object2FloatFunction <K> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }
	/** An unmodifiable wrapper class for functions. */
	public static class UnmodifiableFunction <K> extends AbstractObject2FloatFunction <K> implements java.io.Serializable {
	 private static final long serialVersionUID = -7046029254386353129L;
	 protected final Object2FloatFunction <K> function;
	 ...
	 @Override
	 public float getFloat(final Object k) { return function.getFloat(k); }
	 @Override
	 ...
	 */
	public static <K> Object2FloatFunction <K> unmodifiable(final Object2FloatFunction <K> f) { return new UnmodifiableFunction <>(f); }
	...
	public static class PrimitiveFunction <K> implements Object2FloatFunction <K> {
	 ...
	 @Deprecated
	 @Override
	 public Float put(final K key, final Float value) { throw new UnsupportedOperationException(); }
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <K> Object2FloatFunction <K> primitive(final java.util.function.Function<? super K, ? extends Float> f) {
	 java.util.Objects.requireNonNull(f);
	 if (f instanceof Object2FloatFunction) return (Object2FloatFunction <K>) f;
	 if (f instanceof java.util.function.ToDoubleFunction)
	  return key -> it.unimi.dsi.fastutil.SafeMath.safeDoubleToFloat(((java.util.function.ToDoubleFunction <K>) f).applyAsDouble((K)(key)));
