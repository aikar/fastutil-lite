...
public final class DoubleBigArrays {
	...
	private static final class BigArrayHashStrategy implements Hash.Strategy<double[][]>, java.io.Serializable {
	 ...
	 @Override
	 public int hashCode(final double[][] o) { return java.util.Arrays.deepHashCode(o); }
	 @Override
	 public boolean equals(final double[][] a, final double[][] b) { return DoubleBigArrays.equals(a, b); }
	}
	/** A type-specific content-based hash strategy for big arrays.
	 *
