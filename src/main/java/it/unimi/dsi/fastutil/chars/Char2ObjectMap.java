...
public interface Char2ObjectMap <V> extends Char2ObjectFunction <V>, Map<Character,V> {
	 ...
	 * @since 8.0.0
	 */
	default V replace(final char key, final V value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	@Deprecated
	@Override
	default V computeIfPresent(final Character key, final java.util.function.BiFunction<? super Character, ? super V, ? extends V> remappingFunction) {
	...
	@Deprecated
	@Override
	default V compute(final Character key, final java.util.function.BiFunction<? super Character, ? super V, ? extends V> remappingFunction) {
	...
	@Deprecated
	@Override
	default V merge(final Character key, final V value, final java.util.function.BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
