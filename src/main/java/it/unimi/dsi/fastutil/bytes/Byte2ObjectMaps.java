...
public final class Byte2ObjectMaps {
	...
	public static class SynchronizedMap <V> extends Byte2ObjectFunctions.SynchronizedFunction <V> implements Byte2ObjectMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public V computeIfAbsentPartial(final byte key, final Byte2ObjectFunction <? extends V> mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }
	 @Override
	...
	public static class UnmodifiableMap <V> extends Byte2ObjectFunctions.UnmodifiableFunction <V> implements Byte2ObjectMap <V>, java.io.Serializable {
	 ...
	 public void putAll(final Map<? extends Byte, ? extends V> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Byte2ObjectMap.Entry <V> > byte2ObjectEntrySet() { if (entries == null) entries = ObjectSets.unmodifiable(map.byte2ObjectEntrySet()); return entries; }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 // Defaultable methods
	 @Override
	 public V getOrDefault(final byte key, final V defaultValue) { return map.getOrDefault(key, defaultValue); }
	 @Override
	 ...
	 @Override
	 public V computeIfAbsentPartial(final byte key, final Byte2ObjectFunction <? extends V> mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 */
	public static <V> Byte2ObjectMap <V> unmodifiable(final Byte2ObjectMap <V> m) { return new UnmodifiableMap <>(m); }
}
