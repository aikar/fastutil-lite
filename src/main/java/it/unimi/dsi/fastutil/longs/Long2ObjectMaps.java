...
public final class Long2ObjectMaps {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <V> void fastForEach(Long2ObjectMap <V> map, final Consumer<? super Long2ObjectMap.Entry <V> > consumer) {
	 final ObjectSet<Long2ObjectMap.Entry <V> > entries = map.long2ObjectEntrySet();
	 if (entries instanceof Long2ObjectMap.FastEntrySet) ((Long2ObjectMap.FastEntrySet <V>) entries).fastForEach(consumer);
	...
	public static <V> ObjectIterable<Long2ObjectMap.Entry <V> > fastIterable(Long2ObjectMap <V> map) {
	 ...
	 return entries instanceof Long2ObjectMap.FastEntrySet ? new ObjectIterable<Long2ObjectMap.Entry <V> >() {
	  ...
	  public void forEach(final Consumer<? super Long2ObjectMap.Entry <V> > consumer) { ((Long2ObjectMap.FastEntrySet <V>)entries).fastForEach(consumer); }
	 } : entries;
	}
	...
	public static class Singleton <V> extends Long2ObjectFunctions.Singleton <V> implements Long2ObjectMap <V>, java.io.Serializable, Cloneable {
	 ...
	 public void putAll(final Map<? extends Long, ? extends V> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Long2ObjectMap.Entry <V> > long2ObjectEntrySet() { if (entries == null) entries = ObjectSets.singleton(new AbstractLong2ObjectMap.BasicEntry <>(key, value)); return entries; }
	 /** {@inheritDoc}
	 ...
	 */
	public static <V> Long2ObjectMap <V> singleton(final long key, V value) { return new Singleton <>(key, value); }
	/** Returns a type-specific immutable map containing only the specified pair. The returned map is serializable and cloneable.
	 *
	 * <p>Note that albeit the returned map is immutable, its default return value may be changed.
	 *
	 ...
	 * @return a type-specific immutable map containing just the pair {@code &lt;key,value&gt;}.
	 */
	public static <V> Long2ObjectMap <V> singleton(final Long key, final V value) { return new Singleton <>((key).longValue(), (value)); }
	...
	public static class SynchronizedMap <V> extends Long2ObjectFunctions.SynchronizedFunction <V> implements Long2ObjectMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Long2ObjectMap.Entry <V> > long2ObjectEntrySet() { synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.long2ObjectEntrySet(), sync); return entries; } }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 @Override
	 public V computeIfAbsentPartial(final long key, final Long2ObjectFunction <? extends V> mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }
	 @Override
	 ...
	 */
	public static <V> Long2ObjectMap <V> synchronize(final Long2ObjectMap <V> m) { return new SynchronizedMap <>(m); }
	 ...
	 * @see java.util.Collections#synchronizedMap(Map)
	 */
	public static <V> Long2ObjectMap <V> synchronize(final Long2ObjectMap <V> m, final Object sync) { return new SynchronizedMap <>(m, sync); }
	...
	public static class UnmodifiableMap <V> extends Long2ObjectFunctions.UnmodifiableFunction <V> implements Long2ObjectMap <V>, java.io.Serializable {
	 ...
	 // Defaultable methods
	 @Override
	 public V getOrDefault(final long key, final V defaultValue) { return map.getOrDefault(key, defaultValue); }
	 @Override
	 ...
	 @Override
	 public V computeIfAbsentPartial(final long key, final Long2ObjectFunction <? extends V> mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 */
	public static <V> Long2ObjectMap <V> unmodifiable(final Long2ObjectMap <V> m) { return new UnmodifiableMap <>(m); }
}
