...
public final class Long2ObjectFunctions {
	...
	public static class Singleton <V> extends AbstractLong2ObjectFunction <V> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public V get(final long k) { return ( (key) == (k) ) ? value : defRetValue; }
	 @Override
	...
	public static class SynchronizedFunction <V> implements Long2ObjectFunction <V>, java.io.Serializable {
	 ...
	 @Override
	 public V apply(long operand) { synchronized(sync) { return function.apply(operand); } }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 public V apply(final Long key) { synchronized (sync) { return function.apply(key); } }
	 @Override
	 ...
	 */
	public static <V> Long2ObjectFunction <V> synchronize(final Long2ObjectFunction <V> f) { return new SynchronizedFunction <>(f); }
	 ...
	 * @see java.util.Collections#synchronizedMap(java.util.Map)
	 */
	public static <V> Long2ObjectFunction <V> synchronize(final Long2ObjectFunction <V> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }
	 ...
	 */
	public static <V> Long2ObjectFunction <V> unmodifiable(final Long2ObjectFunction <V> f) { return new UnmodifiableFunction <>(f); }
	...
	public static class PrimitiveFunction <V> implements Long2ObjectFunction <V> {
	 ...
	 @Deprecated
	 @Override
	 public V put(final Long key, final V value) { throw new UnsupportedOperationException(); }
	}
	...
	public static <V> Long2ObjectFunction <V> primitive(final java.util.function.Function<? super Long, ? extends V> f) {
	 ...
	 if (f instanceof Long2ObjectFunction) return (Long2ObjectFunction <V>) f;
