...
public final class LongBigArrays {
	...
	private static final class BigArrayHashStrategy implements Hash.Strategy<long[][]>, java.io.Serializable {
	 ...
	 @Override
	 public int hashCode(final long[][] o) { return java.util.Arrays.deepHashCode(o); }
	 @Override
	 public boolean equals(final long[][] a, final long[][] b) { return LongBigArrays.equals(a, b); }
	}
	/** A type-specific content-based hash strategy for big arrays.
	 *
