...
public final class Short2ObjectFunctions {
	 ...
	 */
	public static class EmptyFunction <V> extends AbstractShort2ObjectFunction <V> implements java.io.Serializable, Cloneable {
	 private static final long serialVersionUID = -7046029254386353129L;
	 protected EmptyFunction() {}
	 @Override
	 public V get(final short k) { return (null); }
	 @Override
	 ...
	 * a type-specific function.
	 */
	public static class Singleton <V> extends AbstractShort2ObjectFunction <V> implements java.io.Serializable, Cloneable {
	 private static final long serialVersionUID = -7046029254386353129L;
	 ...
	 @Override
	 public V get(final short k) { return ( (key) == (k) ) ? value : defRetValue; }
	 @Override
	...
	public static class SynchronizedFunction <V> implements Short2ObjectFunction <V>, java.io.Serializable {
	 ...
	 @Deprecated
	 @Override
	 public V apply(final Short key) { synchronized (sync) { return function.apply(key); } }
	 @Override
	 ...
	 @Override
	 public V put(final short k, final V v) { synchronized(sync) { return function.put(k, v); } }
	 @Override
	 public V get(final short k) { synchronized(sync) { return function.get(k); } }
	 @Override
	 public V remove(final short k) { synchronized(sync) { return function.remove(k); } }
	 @Override
	 ...
	 */
	public static <V> Short2ObjectFunction <V> synchronize(final Short2ObjectFunction <V> f) { return new SynchronizedFunction <>(f); }
	 ...
	 * @see java.util.Collections#synchronizedMap(java.util.Map)
	 */
	public static <V> Short2ObjectFunction <V> synchronize(final Short2ObjectFunction <V> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }
	/** An unmodifiable wrapper class for functions. */
	public static class UnmodifiableFunction <V> extends AbstractShort2ObjectFunction <V> implements java.io.Serializable {
	 private static final long serialVersionUID = -7046029254386353129L;
	 protected final Short2ObjectFunction <V> function;
	 ...
	 @Override
	 public V get(final short k) { return function.get(k); }
	 @Override
	 ...
	 */
	public static <V> Short2ObjectFunction <V> unmodifiable(final Short2ObjectFunction <V> f) { return new UnmodifiableFunction <>(f); }
	...
	public static class PrimitiveFunction <V> implements Short2ObjectFunction <V> {
	 ...
	 @Override
	 public boolean containsKey(short key) { return function.apply(Short.valueOf(key)) != null; }
	 ...
	 @Deprecated
	 @Override
	 public V put(final Short key, final V value) { throw new UnsupportedOperationException(); }
	}
	...
	public static <V> Short2ObjectFunction <V> primitive(final java.util.function.Function<? super Short, ? extends V> f) {
	 java.util.Objects.requireNonNull(f);
	 if (f instanceof Short2ObjectFunction) return (Short2ObjectFunction <V>) f;
