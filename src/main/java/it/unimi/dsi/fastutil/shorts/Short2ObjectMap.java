...
public interface Short2ObjectMap <V> extends Short2ObjectFunction <V>, Map<Short,V> {
	 ...
	 * @since 8.0.0
	 */
	default V replace(final short key, final V value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	 ...
	 * @since 8.0.0
	 */
	default V computeIfPresent(final short key, final java.util.function.BiFunction<? super Short, ? super V, ? extends V> remappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default V compute(final short key, final java.util.function.BiFunction<? super Short, ? super V, ? extends V> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final V oldValue = get(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default V merge(final short key, final V value, final java.util.function.BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
