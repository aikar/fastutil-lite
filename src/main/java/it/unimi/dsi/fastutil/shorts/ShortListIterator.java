...
public interface ShortListIterator extends ShortBidirectionalIterator , ListIterator<Short> {
	 ...
	 */
	default void set(final short k) { throw new UnsupportedOperationException(); }
	/**
	 ...
	 */
	default void add(final short k) { throw new UnsupportedOperationException(); }
	/**
	...
	@Deprecated
	@Override
	default void set(final Short k) { set(k.shortValue()); }
	/** {@inheritDoc}
	 * @deprecated Please use the corresponding type-specific method instead. */
	@Deprecated
	@Override
	default void add(final Short k) { add(k.shortValue()); }
	/** {@inheritDoc}
	 * @deprecated Please use the corresponding type-specific method instead. */
	@Deprecated
	@Override
	default Short next() { return ShortBidirectionalIterator.super.next(); }
	/** {@inheritDoc}
	 * @deprecated Please use the corresponding type-specific method instead. */
	@Deprecated
	@Override
	default Short previous() { return ShortBidirectionalIterator.super.previous(); }
}
