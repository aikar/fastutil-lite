...
/** A type-specific hash map with a fast, small-footprint implementation whose {@linkplain it.unimi.dsi.fastutil.Hash.Strategy hashing strategy}
	...
	*/
public class Short2ObjectOpenCustomHashMap <V> extends AbstractShort2ObjectMap <V> implements java.io.Serializable, Cloneable, Hash {
	...
	public Short2ObjectOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 */
	public Short2ObjectOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 */
	public Short2ObjectOpenCustomHashMap(final Map<? extends Short, ? extends V> m, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 */
	public Short2ObjectOpenCustomHashMap(final Map<? extends Short, ? extends V> m, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 */
	public Short2ObjectOpenCustomHashMap(final Short2ObjectMap <V> m, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	 ...
	 */
	public Short2ObjectOpenCustomHashMap(final Short2ObjectMap <V> m, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 */
	public Short2ObjectOpenCustomHashMap(final short[] k, final V[] v, final float f, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	 ...
	 */
	public Short2ObjectOpenCustomHashMap(final short[] k, final V[] v, final it.unimi.dsi.fastutil.shorts.ShortHash.Strategy strategy) {
	...
	public boolean containsValue(final Object v) {
	 ...
	 for(int i = n; i-- != 0;) if (! ( (key[i]) == ((short)0) ) && java.util.Objects.equals(value[i], v)) return true;
	 return false;
	}
	/** {@inheritDoc} */
	@Override
	...
	/** {@inheritDoc} */
	@Override
	public V computeIfPresent(final short k, final java.util.function.BiFunction<? super Short, ? super V, ? extends V> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public V compute(final short k, final java.util.function.BiFunction<? super Short, ? super V, ? extends V> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public V merge(final short k, final V v, final java.util.function.BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	...
	final class MapEntry implements Short2ObjectMap.Entry <V>, Map.Entry<Short, V> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).shortValue()) ) ) && java.util.Objects.equals(value[index], (e.getValue()));
	 }
	 @Override
	 public int hashCode() {
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2ObjectMap.Entry <V> > implements FastEntrySet <V> {
	 @Override
	 public ObjectIterator<Short2ObjectMap.Entry <V> > iterator() { return new EntryIterator(); }
	 @Override
	 public ObjectIterator<Short2ObjectMap.Entry <V> > fastIterator() { return new FastEntryIterator(); }
	 @Override
	 @SuppressWarnings("unchecked")
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), ((short)0) ) )) return Short2ObjectOpenCustomHashMap.this.containsNullKey && java.util.Objects.equals(value[n], v);
	  short curr;
	  final short[] key = Short2ObjectOpenCustomHashMap.this.key;
	  int pos;
	  // The starting point.
	 ...
	 public void forEach(final Consumer<? super Short2ObjectMap.Entry <V> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractShort2ObjectMap.BasicEntry <V>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( (key[pos]) == ((short)0) )) consumer.accept(new AbstractShort2ObjectMap.BasicEntry <V>(key[pos], value[pos]));
	 }
	 /** {@inheritDoc} */
	 @Override
	...
	private final class KeySet extends AbstractShortSet {
	 ...
	 @Override
	 public void clear() { Short2ObjectOpenCustomHashMap.this.clear();}
	}
	@Override
