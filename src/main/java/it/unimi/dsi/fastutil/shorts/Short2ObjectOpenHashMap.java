...
/** A type-specific hash map with a fast, small-footprint implementation.
	...
	* @see HashCommon
	*/
public class Short2ObjectOpenHashMap <V> extends AbstractShort2ObjectMap <V> implements java.io.Serializable, Cloneable, Hash {
	...
	final class MapEntry implements Short2ObjectMap.Entry <V>, Map.Entry<Short, V> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( (key[index]) == ((e.getKey()).shortValue()) ) && java.util.Objects.equals(value[index], (e.getValue()));
	 }
	 @Override
	 public int hashCode() {
	...
	private final class MapEntrySet extends AbstractObjectSet<Short2ObjectMap.Entry <V> > implements FastEntrySet <V> {
	 ...
	 public boolean contains(final Object o) {
	  ...
	  if (( (k) == ((short)0) )) return Short2ObjectOpenHashMap.this.containsNullKey && java.util.Objects.equals(value[n], v);
	  short curr;
	  final short[] key = Short2ObjectOpenHashMap.this.key;
	  int pos;
	  // The starting point.
	...
	private final class KeySet extends AbstractShortSet {
	 ...
	 @Override
	 public void clear() { Short2ObjectOpenHashMap.this.clear();}
	}
	@Override
