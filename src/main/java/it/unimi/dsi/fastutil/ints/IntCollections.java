...
public final class IntCollections {
	...
	public static class SynchronizedCollection implements IntCollection , java.io.Serializable {
	 ...
	 @Override
	 public boolean contains(final int k) { synchronized(sync) { return collection.contains(k); } }
	 @Override
	 ...
	 @Deprecated
	 @Override
	 public int[] toIntArray(final int[] a) { return toArray(a); }
	 @Override
	 public int[] toArray(final int[] a) { synchronized(sync) { return collection.toArray(a); } }
	 @Override
	...
	public static class UnmodifiableCollection implements IntCollection , java.io.Serializable {
	 ...
	 @Override
	 public boolean containsAll(IntCollection c) { return collection.containsAll(c); }
	 @Override
