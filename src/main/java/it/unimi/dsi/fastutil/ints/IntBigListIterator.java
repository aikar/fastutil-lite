...
public interface IntBigListIterator extends IntBidirectionalIterator , BigListIterator<Integer> {
	 ...
	 */
	default void set(@SuppressWarnings("unused") final int k) { throw new UnsupportedOperationException(); }
	/**
	 * Inserts the specified element into the list (optional operation).
	 * @see java.util.ListIterator#add(Object)
	 */
	default void add(@SuppressWarnings("unused") final int k) { throw new UnsupportedOperationException(); }
