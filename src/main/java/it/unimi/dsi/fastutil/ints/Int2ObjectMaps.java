...
public final class Int2ObjectMaps {
	...
	public static <V> void fastForEach(Int2ObjectMap <V> map, final Consumer<? super Int2ObjectMap.Entry <V> > consumer) {
	 final ObjectSet<Int2ObjectMap.Entry <V> > entries = map.int2ObjectEntrySet();
	 if (entries instanceof Int2ObjectMap.FastEntrySet) ((Int2ObjectMap.FastEntrySet <V>) entries).fastForEach(consumer);
	...
	public static <V> ObjectIterable<Int2ObjectMap.Entry <V> > fastIterable(Int2ObjectMap <V> map) {
	 ...
	 return entries instanceof Int2ObjectMap.FastEntrySet ? new ObjectIterable<Int2ObjectMap.Entry <V> >() {
	  ...
	  public void forEach(final Consumer<? super Int2ObjectMap.Entry <V> > consumer) { ((Int2ObjectMap.FastEntrySet <V>)entries).fastForEach(consumer); }
	 } : entries;
	}
	...
	public static class Singleton <V> extends Int2ObjectFunctions.Singleton <V> implements Int2ObjectMap <V>, java.io.Serializable, Cloneable {
	 ...
	 public void putAll(final Map<? extends Integer, ? extends V> m) { throw new UnsupportedOperationException(); }
	 @Override
	 public ObjectSet<Int2ObjectMap.Entry <V> > int2ObjectEntrySet() { if (entries == null) entries = ObjectSets.singleton(new AbstractInt2ObjectMap.BasicEntry <>(key, value)); return entries; }
	 /** {@inheritDoc}
	 ...
	 */
	public static <V> Int2ObjectMap <V> singleton(final int key, V value) { return new Singleton <>(key, value); }
	/** Returns a type-specific immutable map containing only the specified pair. The returned map is serializable and cloneable.
	 *
	 * <p>Note that albeit the returned map is immutable, its default return value may be changed.
	 *
	 ...
	 * @return a type-specific immutable map containing just the pair {@code &lt;key,value&gt;}.
	 */
	public static <V> Int2ObjectMap <V> singleton(final Integer key, final V value) { return new Singleton <>((key).intValue(), (value)); }
	...
	public static class SynchronizedMap <V> extends Int2ObjectFunctions.SynchronizedFunction <V> implements Int2ObjectMap <V>, java.io.Serializable {
	 ...
	 @Override
	 public ObjectSet<Int2ObjectMap.Entry <V> > int2ObjectEntrySet() { synchronized(sync) { if (entries == null) entries = ObjectSets.synchronize(map.int2ObjectEntrySet(), sync); return entries; } }
	 /** {@inheritDoc}
		 * @deprecated Please use the corresponding type-specific method instead. */
	 @Deprecated
	 @Override
	 ...
	 @Override
	 public V computeIfAbsentPartial(final int key, final Int2ObjectFunction <? extends V> mappingFunction) { synchronized(sync) { return map.computeIfAbsentPartial(key, mappingFunction); } }
	 @Override
	 ...
	 */
	public static <V> Int2ObjectMap <V> synchronize(final Int2ObjectMap <V> m) { return new SynchronizedMap <>(m); }
	 ...
	 * @see java.util.Collections#synchronizedMap(Map)
	 */
	public static <V> Int2ObjectMap <V> synchronize(final Int2ObjectMap <V> m, final Object sync) { return new SynchronizedMap <>(m, sync); }
	...
	public static class UnmodifiableMap <V> extends Int2ObjectFunctions.UnmodifiableFunction <V> implements Int2ObjectMap <V>, java.io.Serializable {
	 ...
	 // Defaultable methods
	 @Override
	 public V getOrDefault(final int key, final V defaultValue) { return map.getOrDefault(key, defaultValue); }
	 @Override
	 ...
	 @Override
	 public V computeIfAbsentPartial(final int key, final Int2ObjectFunction <? extends V> mappingFunction) { throw new UnsupportedOperationException(); }
	 @Override
	 ...
	 */
	public static <V> Int2ObjectMap <V> unmodifiable(final Int2ObjectMap <V> m) { return new UnmodifiableMap <>(m); }
}
