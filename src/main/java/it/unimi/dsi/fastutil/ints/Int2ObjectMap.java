...
public interface Int2ObjectMap <V> extends Int2ObjectFunction <V>, Map<Integer,V> {
	 ...
	 * @since 8.0.0
	 */
	default V replace(final int key, final V value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	...
	@Deprecated
	@Override
	default V computeIfPresent(final Integer key, final java.util.function.BiFunction<? super Integer, ? super V, ? extends V> remappingFunction) {
	...
	@Deprecated
	@Override
	default V compute(final Integer key, final java.util.function.BiFunction<? super Integer, ? super V, ? extends V> remappingFunction) {
	...
	@Deprecated
	@Override
	default V merge(final Integer key, final V value, final java.util.function.BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
