...
public final class FloatSets {
	...
	public static class EmptySet extends FloatCollections.EmptyCollection implements FloatSet , java.io.Serializable, Cloneable {
	 ...
	 @Deprecated
	 @Override
	 public boolean rem(final float k) { return super.rem(k); }
	...
	public static class Singleton extends AbstractFloatSet implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public FloatListIterator iterator() { return FloatIterators.singleton(element); }
	 @Override
	...
	public static class SynchronizedSet extends FloatCollections.SynchronizedCollection implements FloatSet , java.io.Serializable {
	 ...
	 @Override
	 public boolean remove(final float k) { synchronized(sync) { return collection.rem(k); } }
	 @Deprecated
	 @Override
	 public boolean rem(final float k) { return super.rem(k); }
	}
	 ...
	 */
	public static FloatSet synchronize(final FloatSet s) { return new SynchronizedSet (s); }
	 ...
	 * @see java.util.Collections#synchronizedSet(Set)
	 */
	public static FloatSet synchronize(final FloatSet s, final Object sync) { return new SynchronizedSet (s, sync); }
	 ...
	 */
	public static FloatSet unmodifiable(final FloatSet s) { return new UnmodifiableSet (s); }
}
