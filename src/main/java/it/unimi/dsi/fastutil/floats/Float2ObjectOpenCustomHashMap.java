...
/** A type-specific hash map with a fast, small-footprint implementation whose {@linkplain it.unimi.dsi.fastutil.Hash.Strategy hashing strategy}
	...
	*/
public class Float2ObjectOpenCustomHashMap <V> extends AbstractFloat2ObjectMap <V> implements java.io.Serializable, Cloneable, Hash {
	...
	public Float2ObjectOpenCustomHashMap(final int expected, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 */
	public Float2ObjectOpenCustomHashMap(final int expected, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 */
	public Float2ObjectOpenCustomHashMap(final Map<? extends Float, ? extends V> m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 */
	public Float2ObjectOpenCustomHashMap(final Map<? extends Float, ? extends V> m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 */
	public Float2ObjectOpenCustomHashMap(final Float2ObjectMap <V> m, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m.size(), f, strategy);
	 putAll(m);
	}
	 ...
	 */
	public Float2ObjectOpenCustomHashMap(final Float2ObjectMap <V> m, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 this(m, DEFAULT_LOAD_FACTOR, strategy);
	}
	 ...
	 */
	public Float2ObjectOpenCustomHashMap(final float[] k, final V[] v, final float f, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	 ...
	 */
	public Float2ObjectOpenCustomHashMap(final float[] k, final V[] v, final it.unimi.dsi.fastutil.floats.FloatHash.Strategy strategy) {
	...
	private int find(final float k) {
	 ...
	 int pos;
	 // The starting point.
	 if (( Float.floatToIntBits(curr = key[pos = ( it.unimi.dsi.fastutil.HashCommon.mix( strategy.hashCode(k) ) ) & mask]) == 0 )) return -(pos + 1);
	...
	public V remove(final float k) {
	 ...
	 int pos;
	 // The starting point.
	 if (( Float.floatToIntBits(curr = key[pos = ( it.unimi.dsi.fastutil.HashCommon.mix( strategy.hashCode(k) ) ) & mask]) == 0 )) return defRetValue;
	...
	public boolean containsValue(final Object v) {
	 ...
	 for(int i = n; i-- != 0;) if (! ( Float.floatToIntBits(key[i]) == 0 ) && java.util.Objects.equals(value[i], v)) return true;
	 return false;
	}
	/** {@inheritDoc} */
	@Override
	...
	public V getOrDefault(final float k, final V defaultValue) {
	 ...
	 int pos;
	 // The starting point.
	 if (( Float.floatToIntBits(curr = key[pos = ( it.unimi.dsi.fastutil.HashCommon.mix( strategy.hashCode(k) ) ) & mask]) == 0 )) return defaultValue;
	 if (( strategy.equals( (k), (curr) ) )) return value[pos];
	 // There's always an unused entry.
	 while(true) {
	...
	/** {@inheritDoc} */
	@Override
	public V computeIfPresent(final float k, final java.util.function.BiFunction<? super Float, ? super V, ? extends V> remappingFunction) {
	...
	/** {@inheritDoc} */
	@Override
	public V compute(final float k, final java.util.function.BiFunction<? super Float, ? super V, ? extends V> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	...
	/** {@inheritDoc} */
	@Override
	public V merge(final float k, final V v, final java.util.function.BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final int pos = find(k);
	...
	final class MapEntry implements Float2ObjectMap.Entry <V>, Map.Entry<Float, V> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  return ( strategy.equals( (key[index]), ((e.getKey()).floatValue()) ) ) && java.util.Objects.equals(value[index], (e.getValue()));
	 }
	 @Override
	 public int hashCode() {
	...
	private class MapIterator {
	 ...
	 public int nextEntry() {
	  ...
	  for(;;) {
	   ...
	   if (! ( Float.floatToIntBits(key[pos]) == 0 )) return last = pos;
	  }
	 }
	 /** Shifts left entries with the specified hash code, starting at the specified position,
	...
	private final class MapEntrySet extends AbstractObjectSet<Float2ObjectMap.Entry <V> > implements FastEntrySet <V> {
	 @Override
	 public ObjectIterator<Float2ObjectMap.Entry <V> > iterator() { return new EntryIterator(); }
	 @Override
	 public ObjectIterator<Float2ObjectMap.Entry <V> > fastIterator() { return new FastEntryIterator(); }
	 @Override
	 @SuppressWarnings("unchecked")
	 public boolean contains(final Object o) {
	  ...
	  if (( strategy.equals( (k), (0) ) )) return Float2ObjectOpenCustomHashMap.this.containsNullKey && java.util.Objects.equals(value[n], v);
	  float curr;
	  final float[] key = Float2ObjectOpenCustomHashMap.this.key;
	  int pos;
	  // The starting point.
	 ...
	 public void forEach(final Consumer<? super Float2ObjectMap.Entry <V> > consumer) {
	  if (containsNullKey) consumer.accept(new AbstractFloat2ObjectMap.BasicEntry <V>(key[n], value[n]));
	  for(int pos = n; pos-- != 0;)
	   if (! ( Float.floatToIntBits(key[pos]) == 0 )) consumer.accept(new AbstractFloat2ObjectMap.BasicEntry <V>(key[pos], value[pos]));
	 }
	 /** {@inheritDoc} */
	 @Override
	...
	private final class KeySet extends AbstractFloatSet {
	 @Override
	 public FloatIterator iterator() { return new KeyIterator(); }
	 /** {@inheritDoc} */
	 @Override
	 public void forEach(final java.util.function.DoubleConsumer consumer) {
	  ...
	  for(int pos = n; pos-- != 0;) {
	   ...
	   if (! ( Float.floatToIntBits(k) == 0 )) consumer.accept(k);
	  }
	 }
	 @Override
	 public int size() { return size; }
	 @Override
	 public boolean contains(float k) { return containsKey(k); }
	 @Override
	 ...
	 @Override
	 public void clear() { Float2ObjectOpenCustomHashMap.this.clear();}
	}
	@Override
	...
	public ObjectCollection <V> values() {
	 if (values == null) values = new AbstractObjectCollection <V>() {
	   ...
	   public void forEach(final Consumer <? super V> consumer) {
	    ...
	    for(int pos = n; pos-- != 0;)
	     if (! ( Float.floatToIntBits(key[pos]) == 0 )) consumer.accept(value[pos]);
	   }
	  };
	 return values;
	}
