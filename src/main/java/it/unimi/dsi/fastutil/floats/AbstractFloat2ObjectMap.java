...
/** An abstract class providing basic methods for maps implementing a type-specific interface.
	...
	*/
public abstract class AbstractFloat2ObjectMap <V> extends AbstractFloat2ObjectFunction <V> implements Float2ObjectMap <V>, java.io.Serializable {
	...
	public static class BasicEntry <V> implements Float2ObjectMap.Entry <V> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  if (o instanceof Float2ObjectMap.Entry) {
	   ...
	   return ( Float.floatToIntBits(key) == Float.floatToIntBits(e.getFloatKey()) ) && java.util.Objects.equals(value, e.getValue());
	  }
	  final Map.Entry<?,?> e = (Map.Entry<?,?>)o;
	  final Object key = e.getKey();
	  if (key == null || !(key instanceof Float)) return false;
	  final Object value = e.getValue();
	  return ( Float.floatToIntBits(this.key) == Float.floatToIntBits(((Float)(key)).floatValue()) ) && java.util.Objects.equals(this.value, (value));
	 }
	 @Override
	 public int hashCode() {
	...
	public FloatSet keySet() {
	 return new AbstractFloatSet () {
	   ...
	   @Override
	   public int size() { return AbstractFloat2ObjectMap.this.size(); }
	   @Override
	   public void clear() { AbstractFloat2ObjectMap.this.clear(); }
	   @Override
