...
public final class Float2ObjectFunctions {
	...
	public static class Singleton <V> extends AbstractFloat2ObjectFunction <V> implements java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public V get(final float k) { return ( Float.floatToIntBits(key) == Float.floatToIntBits(k) ) ? value : defRetValue; }
	 @Override
	...
	public static class SynchronizedFunction <V> implements Float2ObjectFunction <V>, java.io.Serializable {
	 ...
	 @Deprecated
	 @Override
	 public V apply(final Float key) { synchronized (sync) { return function.apply(key); } }
	 @Override
	 ...
	 */
	public static <V> Float2ObjectFunction <V> synchronize(final Float2ObjectFunction <V> f) { return new SynchronizedFunction <>(f); }
	 ...
	 * @see java.util.Collections#synchronizedMap(java.util.Map)
	 */
	public static <V> Float2ObjectFunction <V> synchronize(final Float2ObjectFunction <V> f, final Object sync) { return new SynchronizedFunction <>(f, sync); }
	 ...
	 */
	public static <V> Float2ObjectFunction <V> unmodifiable(final Float2ObjectFunction <V> f) { return new UnmodifiableFunction <>(f); }
	...
	public static class PrimitiveFunction <V> implements Float2ObjectFunction <V> {
	 ...
	 @Deprecated
	 @Override
	 public V put(final Float key, final V value) { throw new UnsupportedOperationException(); }
	}
	...
	public static <V> Float2ObjectFunction <V> primitive(final java.util.function.Function<? super Float, ? extends V> f) {
	 java.util.Objects.requireNonNull(f);
	 if (f instanceof Float2ObjectFunction) return (Float2ObjectFunction <V>) f;
