...
public interface Float2ObjectMap <V> extends Float2ObjectFunction <V>, Map<Float,V> {
	 ...
	 * @since 8.0.0
	 */
	default V replace(final float key, final V value) { return containsKey(key) ? put(key, value) : defaultReturnValue(); }
	 ...
	 * @since 8.0.0
	 */
	default V computeIfPresent(final float key, final java.util.function.BiFunction<? super Float, ? super V, ? extends V> remappingFunction) {
	 ...
	 * @since 8.0.0
	 */
	default V compute(final float key, final java.util.function.BiFunction<? super Float, ? super V, ? extends V> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
	 final V oldValue = get(key), drv = defaultReturnValue();
	 ...
	 * @since 8.0.0
	 */
	default V merge(final float key, final V value, final java.util.function.BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
	 java.util.Objects.requireNonNull(remappingFunction);
