...
public class FloatArraySet extends AbstractFloatSet implements java.io.Serializable, Cloneable {
	 ...
	 */
	public FloatArraySet() { this.a = FloatArrays.EMPTY_ARRAY; }
	/** Creates a new empty array set of given initial capacity.
	 *
	 * @param capacity the initial capacity.
	 */
	public FloatArraySet(final int capacity) { this.a = new float[capacity]; }
	...
	@Override
	public boolean contains(final float k) { return findKey(k) != -1; }
	@Override
